...
public class Dic extends JFrame {
    ...
    private JTextField jtxinput = new JTextField();
    private JTextArea jtxsuggest = new JTextArea(6, 20);
    private JTextArea jtxmean = new JTextArea();
    private JTextArea jtxbot = new JTextArea(1, 20);
    private JButton addword = new JButton("Add Word");
    private JButton deleteword = new JButton("Delete Word");
    private JButton editword = new JButton("Edit Word");
    ...
    private Dic() {
        ...
        jtxsuggest.setLineWrap(true); //thiết lập tự động xuống dòng => Thanh cuộn ngang sẽ không bao giờ xuất hiện nhưng từ bị ngắt.
